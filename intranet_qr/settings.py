"""
Django settings for intranet_qr project.
...
SECRET_KEY = 'django-insecure-^_2n*z4p!f1-tjg^l^3t5-fd#0#7_e)iqkodr48##9*z&8rw8q'
...
WSGI_APPLICATION = 'intranet_qr.wsgi.application'
